...
def main():
    ...
    save()
    splits = {}
    for name, count, offset in [('train', args.train, 1000), ('val', args.val, 100000), ('test', args.test, 200000)]:
    ...
    stats['identity_baseline'] = means(evaluate(lambda z: z[:, None, :3].expand(-1, 3, -1, -1, -1, -1), xtest, ytest)) if False else None
