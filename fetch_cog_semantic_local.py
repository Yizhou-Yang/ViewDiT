...
ROOT = Path('/Users/yizhouyang/With/20260921/m6sk/models/CogVideoX-2b')
META = Path('/Users/yizhouyang/With/20260921/m6sk/cog_semantic_index.json')
BASE = 'https://huggingface.co/THUDM/CogVideoX-2b/resolve/main/'
...
def fetch(row):
    ...
    with urllib.request.urlopen(BASE + row['path'] + '?download=true', timeout=120) as r, temp.open('wb') as f:
        while True:
